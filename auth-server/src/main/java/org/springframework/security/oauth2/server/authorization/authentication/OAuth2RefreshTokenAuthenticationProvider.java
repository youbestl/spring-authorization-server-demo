...
public final class OAuth2RefreshTokenAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        OAuth2Authorization.Token<CustomRefreshToken> refreshToken = authorization.getToken(CustomRefreshToken.class);
        ...
        OAuth2TokenContext tokenContext = tokenContextBuilder
                .authorizedScopes(refreshToken.getToken().getScopes())
