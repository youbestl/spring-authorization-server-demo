 ...
 */
package com.crane.soft;

import com.crane.soft.auth.server.OAuth2ServerApplication;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = OAuth2ServerApplication.class)
@AutoConfigureMockMvc
public class DemoAuthorizationServerApplicationTests {
    private static final String REDIRECT_URI = "http://127.0.0.1:8081/login/oauth2/code/messaging-client-oidc";
    ...
    public void whenLoginSuccessfulThenDisplayBadRequestError() throws IOException {
        ...
        WebResponse signInResponse = signIn(page, "user", "123456").getWebResponse();
    ...
    public void whenLoggingInAndRequestingTokenThenRedirectsToClientApplication() throws IOException {
        ...
        signIn(this.webClient.getPage("/login"), "user", "123456");
